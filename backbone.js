...
// Disabled 'prefer-spread' as this code isn't compiled into ES5.
...
var Events = Backbone.Events = {
    ...
    // time the callback is invoked, it will be removed.
...
// Copy of `isEqual` from Underscore
var isEqual = function(a, b, aStack, bStack) {
    ...
    switch (className) {
        ...
        case '[object Boolean]':
            ...
            // are compared by their millisecond representations. Note that
            // invalid dates with millisecond representations of `NaN` are
            // not equivalent.
            return +a === +b;
    }
    ...
    if (!areArrays) {
        ...
        if (aCtor !== bCtor && !(typeof aCtor === "function" &&
            aCtor instanceof aCtor && typeof bCtor === "function" &&
            bCtor instanceof bCtor) && ('constructor' in a &&
            'constructor' in b)) {
            return false;
        }
    }
    ...
    if (areArrays) {
        ...
        while (length--) {
            ...
            if (!(b.hasOwnProperty(key) &&
                    isEqual(a[key], b[key], aStack, bStack))) {
                return false;
            }
        }
    }
...
Object.assign(Model.prototype, Events, {
    ...
    set: function(key, val, options) {
        ...
        // can be recursively nested within `"change"` events.
        if (changing) {
            return this;
        }
        if (!silent) {
    ...
    unset: function(attr, options) {
        return this.set(attr, void 0, Object.assign({}, options,
            {unset: true}));
    },
    ...
    // the model differs from its current attributes, they will be
    // overridden, triggering a `"change"` event.
    ...
    url: function() {
        var urlRoot = (typeof this.urlRoot === "function" ?
    ...
    // **parse** converts a response into the hash of attributes to be
    // `set` on the model. The default implementation is just to pass the
    // response along.
